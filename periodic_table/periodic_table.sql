...
ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_unique UNIQUE (symbol);


--
-- Name: elements elements_unique_1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_unique_1 UNIQUE (name);
